...
3. x Install the Express npm package: `npm install express --save`.

4. x Create a server.js file.

5. x Install the Handlebars npm package: `npm install express-handlebars --save`.

6. x Install the method-override npm package: `npm install method-override --save`.

7. x Install the body-parser npm package: `npm install body-parser --save`.

8. x Install MySQL npm package: `npm install mysql --save`.

9. x Require the following npm packages inside of the server.js file:
   * express
   * method-override
   * body-parser
